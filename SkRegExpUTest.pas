...
//  x2('(cc)\g{+1}(ab)', 'ccabab', 1, 6);
  ...
  x2('(?mi)\byz\b', TSkRegExp.DecodeEscape('\x{00B0}yz'), 2, 2);
  ...
  n('[0-9]{2}(0[1-9]|1[012])(0[1-9]|1[0-9]|2[0-9]|3[01])[\s]{0,2}?[-]?[\s]{0,2}?[012349][0-9]{6}',
    ' SS-20070511 ');
  x2('\b[А-Я]([^А-Я\d]+)', 'Я Яяяя', 1, 2);
  x2('(?i)(\bmark\b)\s(\d+)([^\<\-\d+\.\,\\\/\:])', 'mark 4 x', 1, 7);
  x2( '(?i)[\dあが-ご]+', 'ぎ４', 1, 2);
  x2('(?i)[^\dあが-ご]+', 'ぎ４えい', 3, 2);
  x2('(?i)[^\da-cあが-ご]+', 'ぎ４AB0xy', 6, 2);

  n('(\d{1,3})\0{6}', '146000000'#13#10);
